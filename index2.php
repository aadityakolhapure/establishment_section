...
if (isset($_POST['signin'])) {
    ...
    $sql = "SELECT UserName,Password FROM tblemployees WHERE EmailId=:EmailId and Password=:Password";
                ...
                <form action="index.php" method="POST" name="signin">
                    ...
                    <div class="login-form-body">
                        <div class="form-gp">
                            ...
                            <input type="email" id="username" name="EmailId" autocomplete="off" required>
                            <i class="ti-email"></i>
